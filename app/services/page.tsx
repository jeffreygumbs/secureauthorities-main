...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: Monitor,
      description: "Cross-platform desktop applications for enterprise environments",
    ...
    },
    {
      ...
      icon: Shield,
      description: "Comprehensive security solutions protecting your digital infrastructure",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-[980px] mx-auto px-8 text-center">
          ...
          <p className="text-xl text-black/60 max-w-[700px] mx-auto leading-relaxed">
            Full-stack expertise across web, mobile, desktop, and security
          </p>
        </div>
      </section>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  ...
                  <h2 className="text-5xl mb-6 tracking-tight text-black">{service.title}</h2>
      ...
      <section className="py-32 bg-linear-to-br from-[#f5f5f7] via-white to-[#f5f5f7]">
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl mb-6 tracking-tight text-black">Our Process</h2>
            <p className="text-xl text-black/60">
              Proven methodology delivering exceptional results
            </p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Discovery",
                description: "Understanding requirements and defining goals",
              },
              {
                step: "02",
                title: "Design",
              ...
              },
              {
                step: "04",
                title: "Launch",
                description: "Deploying with ongoing support",
              },
            ].map((process, index) => (
              <div key={index} className="backdrop-blur-xl bg-white/40 border border-white/60 rounded-2xl p-8 shadow-xl hover:shadow-[0_20px_60px_rgba(30,79,138,0.1)] transition-all duration-500 hover:-translate-y-1 group">
                ...
                <h3 className="text-xl mb-3 text-black">{process.title}</h3>
      ...
      <section className="py-32 bg-linear-to-br from-black via-[#1e4f8a]/90 to-black text-white relative overflow-hidden">
        ...
        <div className="relative max-w-[980px] mx-auto px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-10 max-w-[600px] mx-auto">
