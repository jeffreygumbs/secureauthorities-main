        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24">
          <div>
            ...
            <p className="text-xl text-black/60 mb-12 leading-relaxed">
              Have a question about our products or services? Our team of experts is ready to help you secure your digital future.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-bold text-black mb-1">Our Offices</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="firstName" className="text-sm font-medium text-black/60 ml-1">First Name</label>
                      <input
                        required
                        type="text"
                        id="firstName"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="lastName" className="text-sm font-medium text-black/60 ml-1">Last Name</label>
                      <input
                        required
                        type="text"
                        id="lastName"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium text-black/60 ml-1">Email Address</label>
                    <input
                      required
                      type="email"
                      id="email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="subject" className="text-sm font-medium text-black/60 ml-1">Subject</label>
                    <select
                      id="subject"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-sm font-medium text-black/60 ml-1">Message</label>
                    <textarea
                      required
                      id="message"
                      rows={4}
