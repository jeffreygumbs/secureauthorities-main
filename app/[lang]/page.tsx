      ...
      <section className="py-20 bg-linear-to-b from-[#f5f5f7] to-white">
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
            {[
              { number: "150+", label: dict.home.stats.clients, icon: Globe },
              { number: "99.9%", label: dict.home.stats.uptime, icon: Shield },
              { number: "24/7", label: dict.home.stats.countries, icon: Zap },
            ].map((stat, index) => (
        ...
        <div className="relative max-w-[1200px] mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="text-center md:text-left">
              <div className="text-xs font-bold text-[#f1b24b] mb-2 tracking-widest uppercase">{dict.home.dono.label}</div>
              <h2 className="text-4xl md:text-6xl mb-6 tracking-tight text-black font-bold">{dict.home.dono.title}</h2>
              <p className="text-lg md:text-xl text-black/60 mb-8 leading-relaxed">
                {dict.home.dono.description}
              </p>
              <Link
                href={`/${lang}/products#dono`}
                className="inline-flex items-center gap-2 text-[#1e4f8a] hover:text-[#4b8ebe] transition-colors group font-medium"
              >
                {dict.home.dono.learnMore}
        ...
        <div className="relative max-w-[1200px] mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="md:order-2 text-center md:text-left">
              <div className="text-xs font-bold text-[#d67d4c] mb-2 tracking-widest uppercase">{dict.home.shadow.label}</div>
              <h2 className="text-4xl md:text-6xl mb-6 tracking-tight text-black font-bold">{dict.home.shadow.title}</h2>
              <p className="text-lg md:text-xl text-black/60 mb-8 leading-relaxed">
                {dict.home.shadow.description}
              </p>
              <Link
                href={`/${lang}/products#shadow`}
                className="inline-flex items-center gap-2 text-[#1e4f8a] hover:text-[#4b8ebe] transition-colors group font-medium"
              >
                {dict.home.shadow.learnMore}
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
      ...
      <section className="py-32">
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: dict.home.services.items.web.title,
                description: dict.home.services.items.web.description,
              ...
              {
                title: dict.home.services.items.mobile.title,
                description: dict.home.services.items.mobile.description,
              ...
              {
                title: dict.home.services.items.desktop.title,
                description: dict.home.services.items.desktop.description,
              ...
              {
                title: dict.home.services.items.security.title,
                description: dict.home.services.items.security.description,
