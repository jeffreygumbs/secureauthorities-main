    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-48 pb-24 relative overflow-hidden">
        ...
        <div className="relative max-w-[980px] mx-auto px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-black/60 max-w-[700px] mx-auto leading-relaxed">
            Protecting the world&apos;s most demanding organizations with advanced security and elite engineering.
          </p>
        </div>
      </section>
      ...
      <section className="py-32 bg-linear-to-b from-[#f5f5f7] to-white">
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              <div className="text-xs font-bold text-[#1e4f8a] mb-4 tracking-widest uppercase">Our Mission</div>
              <h2 className="text-5xl md:text-6xl mb-8 tracking-tight text-black font-bold">Securing the Future</h2>
              <p className="text-lg text-black/60 leading-relaxed mb-6">
                To empower organizations worldwide with cutting-edge security solutions and innovative 
                application development services that drive growth and protect assets.
              </p>
              <p className="text-lg text-black/60 leading-relaxed">
                We believe in a secure digital future where businesses operate confidently with 
                advanced security technologies and robust infrastructure.
              </p>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div className="max-w-2xl">
              <div className="text-xs font-bold text-[#1e4f8a] mb-4 tracking-widest uppercase">Leadership</div>
              <h2 className="text-5xl md:text-6xl tracking-tight text-black font-bold">Expertise at Scale</h2>
            </div>
            <Link 
              href="/leadership" 
      ...
      <section className="py-32 bg-[#f5f5f7]">
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="text-center mb-20">
            <div className="text-xs font-bold text-[#1e4f8a] mb-4 tracking-widest uppercase">Our Values</div>
            <h2 className="text-5xl md:text-6xl tracking-tight text-black font-bold">What Drives Us</h2>
          </div>
            ...
            {[
              {
                icon: Globe,
                title: "Global Reach",
                description: "Offices across 50+ countries with 24/7 localized support",
              },
              {
                icon: Users,
                title: "Expert Team",
                description: "200+ certified professionals dedicated to excellence",
              },
              {
                icon: Award,
                title: "Industry Leader",
                description: "Award-winning innovation in security and development",
              },
              {
                icon: Target,
                title: "Client First",
                description: "99% satisfaction rate with personalized solutions",
              },
            ].map((value, index) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-[980px] mx-auto px-8">
          <div className="text-center mb-20">
            <div className="text-xs font-bold text-[#1e4f8a] mb-4 tracking-widest uppercase">Our History</div>
            <h2 className="text-5xl md:text-6xl tracking-tight text-black font-bold">The Journey</h2>
          </div>
            ...
            {[
              {
                year: "2010",
                title: "Foundation",
                description: "Founded with a vision to revolutionize enterprise cybersecurity and application infrastructure.",
              },
              {
                year: "2015",
                title: "Global Expansion",
                description: "Expanded operations to 10 countries, serving our first Fortune 500 clients in London and New York.",
              },
              {
                year: "2020",
                title: "Product Innovation",
                description: "Launched the Dono and Shadow platforms, setting new benchmarks for cloud data and threat detection.",
              },
              {
                year: "2026",
                title: "Industry Leadership",
                description: "Serving over 150+ enterprise clients globally as a market leader in secure application development.",
              },
            ].map((milestone, index) => (
      ...
      <section className="py-32 bg-linear-to-br from-black via-[#1e4f8a]/90 to-black text-white relative overflow-hidden">
        ...
        <div className="relative max-w-[980px] mx-auto px-8 text-center">
          <h2 className="text-5xl md:text-7xl mb-8 tracking-tight font-bold">Global Presence</h2>
          <p className="text-xl text-white/70 mb-16 max-w-[700px] mx-auto leading-relaxed">
            Our specialized teams are distributed across major global hubs, providing seamless support and engineering excellence regardless of geography.
          </p>
