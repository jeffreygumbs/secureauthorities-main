...
export default function SignUpForm({ dict, lang }: { dict: Dictionary; lang: string }) {
  ...
  return (
    <div className="backdrop-blur-2xl bg-white/60 border border-white/80 rounded-3xl shadow-2xl p-10">
      <div className="text-center mb-10">
        ...
        <p className="text-black/60">{dict.auth.registrationNotice}</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={dict.contact.form.placeholders.firstName + " " + dict.contact.form.placeholders.lastName}
        ...
        <div className="text-xs text-black/60 leading-relaxed">
          ...
          <Link href={`/${lang}/legal/terms`} className="text-[#1e4f8a] hover:underline">{dict.legal.terms.title}</Link> {dict.auth.and}{" "}
          <Link href={`/${lang}/legal/privacy-policy`} className="text-[#1e4f8a] hover:underline">{dict.legal.privacy.title}</Link>.
        </div>
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white/60 text-black/50">{dict.auth.orSignUpWith}</span>
        </div>
      </div>
