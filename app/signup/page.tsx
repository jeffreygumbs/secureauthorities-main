      ...
      <div className="relative w-full max-w-md mx-auto px-8 pt-20">
        <div className="backdrop-blur-2xl bg-white/60 border border-white/80 rounded-3xl shadow-2xl p-10">
          <div className="text-center mb-10">
            <h1 className="text-5xl mb-3 tracking-tight text-black font-bold">Create Account</h1>
            <p className="text-black/60">Join the Secure Authorities ecosystem</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-xs text-black/60 leading-relaxed">
              ...
              <Link href="/legal/terms" className="text-[#1e4f8a] hover:underline">Terms of Service</Link> and{" "}
              <Link href="/legal/privacy-policy" className="text-[#1e4f8a] hover:underline">Privacy Policy</Link>.
            </div>
          ...
          <p className="text-center text-sm text-black/60">
            ...
            <Link href="/signin" className="text-[#1e4f8a] hover:text-[#4b8ebe] transition-colors font-bold">
              Sign in
            </Link>
          </p>
